...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("desk_tip", "Sizinle bağlantı kurmak isteyen çağrı merkezi personeline aşağıdaki ID bilgisini verdikten sonra gelen isteği kabul ediniz."),
        ("Password", "Şifre"),
        ("Ready", "Hazır"),
        ...
        ("install_tip", "RustDesk'i kararlı bir şekilde kullanabilmek için bilgisayarınıza kurmalısınız."),
        ...
        ("setup_server_tip", "Internet hızınızı kontrol edin."),
        ...
        ("Resume", ""),
        ("Invalid file name", ""),
        ("LoginErrorTryingConnect", "Sunucu ile bağlantı kurulamadı."),
        ("one-way-file-transfer-tip", ""),
        ("Authentication Required", ""),
        ("Authenticate", ""),
        ("AccessDenied","Erişim Engellendi."),
        ("DeniedBeforeLogin","İşleme devam edebilmek için oturum açın."),
        ("DeniedUserNotFound","Kullanıcı bulunamadı."),
        ("DeniedUserTrying","Birden fazla kez yanlış giriş yaptınız. 15 dakika bekleyiniz."),
        ("Insert-ctrl-alt-delete","Ctrl + Alt + Delete Gönder"),
        ("VerificationAcceptText","Aydınlatma metni bulunamadı. Daha sonra tekrar bağlantı isteyin..."),
        ("ConnectAcceptOutdatedErrorText","RustDesk eski sürümünü kullanıyorsunuz. Uygulamayı kullanabilmek için yeni sürüm yükleyin..."),
    ].iter().cloned().collect();
}
