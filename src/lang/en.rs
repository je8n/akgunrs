...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ("desk_tip", "Accept the request after giving the ID information below to the call center personnel who want to contact you."),
        ...
        ("install_tip", "In order to use RustDesk stably, you must install it on your computer."),
        ...
        ("Insert-ctrl-alt-delete","Insert Ctrl+Alt+Delete"),
        ("VerificationAcceptText","Verification Text not found. Please try again later..."),
        ("ConnectAcceptOutdatedErrorText","Please upgrade agent new version."),
    ].iter().cloned().collect();
}
