...
const APP_PREFIX: &str = "AkgunRS";
const APPNAME_RUNTIME_ENV_KEY: &str = "AKGUNRS_APPNAME";
#[cfg(windows)]
...
mod windows {
    ...
    pub const WIN_TOPMOST_INJECTED_PROCESS_EXE: &'static str = "RuntimeBroker_akgunrs.exe";
    ...
    pub(super) fn copy_runtime_broker(dir: &PathBuf) {
        ...
        let _allow_err = Command::new("taskkill")
            .args(&["/F", "/IM", "RuntimeBroker_akgunrs.exe"])
