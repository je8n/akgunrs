...
lazy_static::lazy_static! {
    pub static ref ORG: RwLock<String> = RwLock::new("com.akgun".to_owned());
}
...
lazy_static::lazy_static! {
    ...
    pub static ref PROD_RENDEZVOUS_SERVER: RwLock<String> = RwLock::new(match option_env!("RENDEZVOUS_SERVER") {
        ...
        _ => "",
    }.to_owned());    pub static ref EXE_RENDEZVOUS_SERVER: RwLock<String> = Default::default();
    pub static ref APP_NAME: RwLock<String> = RwLock::new("AkgunRS".to_owned());
...
pub const LINK_DOCS_HOME: &str = "https://rs.akgun.com/docs/";
pub const LINK_DOCS_X11_REQUIRED: &str = "https://rs.akgun.com/x11/docs";
pub const LINK_HEADLESS_LINUX_SUPPORT: &str =
    "https://rs.akgun.com/docs/";
lazy_static::lazy_static! {
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["rs.akgun.com.tr"];
pub const PUBLIC_RS_PUB_KEY: &str = "a1CYf8HWO2iFaIY1mpNwmQRkqsOTUY+DtvN+PePtWOI=";
